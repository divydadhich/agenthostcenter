  ...
  >
    ✕
      ...
      <main className="max-w-[430px] mx-auto px-4 pb-10">
        ...
        {/* BALANCE CARD */}
        <div className="mt-4 rounded-2xl bg-gradient-to-r from-[#7b5cff] to-[#6a7cff] p-6 text-white shadow-lg">
        ...
        <div className="grid grid-cols-3 gap-4 mt-6">
          ...
          {/* Exchange */}
          <button className="bg-white rounded-2xl p-4 shadow active:scale-95 transition">
        ...
        <div className="bg-white rounded-2xl p-8 shadow flex flex-col items-center justify-center text-center">
